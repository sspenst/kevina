    ...
    <>
      ...
      <div className='flex flex-col items-center gap-12 m-16'>
        <div className={classNames('flex flex-col items-center gap-4 text-center text-3xl italic', libre.className)}>
          ...
          <a className='hover:text-green-600 underline w-fit text-xl flex gap-2 items-center' href='https://maps.app.goo.gl/gSqQzDLs1HB7dX6C6' target='_blank' rel='noreferrer'>
            <svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' strokeWidth={1.5} stroke='currentColor' className='size-6'>
              <path strokeLinecap='round' strokeLinejoin='round' d='M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z' />
              <path strokeLinecap='round' strokeLinejoin='round' d='M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z' />
            </svg>
            <span>9167 Glover Rd, Langley Twp, BC V1M 2R9</span>
          </a>
          <br />

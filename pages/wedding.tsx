  ...
  return (
    <>
      ...
      <div className={libreBaskerville.className}>
        <WeddingHeader />
        <Image alt='invitation' loading='eager' src='/invitation.jpeg' width={3912} height={3437} className='fixed w-full h-full top-0 opacity-50 object-cover z-0 select-none' />
